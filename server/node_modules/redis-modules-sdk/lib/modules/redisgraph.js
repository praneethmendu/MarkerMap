...
class RedisGraph extends module_base_1.Module {
    ...
    query(name, query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('GRAPH.QUERY', [name, query]);
        });
    }
    /**
     ...
     * @returns Result set
     */
    readonlyQuery(name, query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('GRAPH.RO_QUERY', [name, query]);
        });
    }
    /**
    ...
    profile(name, query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('GRAPH.PROFILE', [name, query]);
        });
    }
    /**
    ...
    delete(name) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('GRAPH.DELETE', [name]);
        });
    }
    /**
    ...
    explain(name, query) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('GRAPH.EXPLAIN', [name, query]);
        });
    }
    /**
    ...
    slowlog(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('GRAPH.SLOWLOG', [id]);
        });
    }
    /**
    ...
    config(command, option, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (command === 'SET')
                args.push(value);
            const response = yield this.sendCommand('GRAPH.CONFIG', args);
