...
class RedisBloomCuckoo extends module_base_1.Module {
    ...
    reserve(key, capacity, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.sendCommand('CF.RESERVE', args);
        });
    }
    /**
    ...
    add(key, item) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('CF.ADD', [key, item]);
        });
    }
    /**
    ...
    addnx(key, item) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('CF.ADDNX', [key, item]);
        });
    }
    /**
    ...
    insert(key, items, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options !== undefined && options.nocreate !== undefined)
                args.push('NOCREATE');
            return yield this.sendCommand('CF.INSERT', args.concat(['ITEMS']).concat(items));
        });
    }
    /**
     * Adding one or more items to a cuckoo filter, allowing the filter to be created with a custom capacity if it does not yet exist.
    ...
    insertnx(key, items, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options !== undefined && options.nocreate !== undefined)
                args.push('NOCREATE');
            return yield this.sendCommand('CF.INSERTNX', args.concat(['ITEMS']).concat(items));
        });
    }
    /**
    ...
    exists(key, item) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('CF.EXISTS', [key, item]);
        });
    }
    /**
    ...
    del(key, item) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('CF.DEL', [key, item]);
        });
    }
    /**
    ...
    count(key, item) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('CF.COUNT', [key, item]);
        });
    }
    /**
    ...
    scandump(key, iterator) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('CF.SCANDUMP', [key, iterator]);
        });
    }
    /**
    ...
    loadchunk(key, iterator, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('CF.LOADCHUNK', [key, iterator, data]);
        });
    }
    /**
    ...
    info(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('CF.INFO', [key]);
        });
    }
}
