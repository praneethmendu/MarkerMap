...
export declare class Redisearch extends Module {
     ...
     */
    search(index: string, query: string, parameters?: FTSearchParameters): Promise<[number, ...Array<string | string[]>]>;
    /**
     ...
     */
    aggregate(index: string, query: string, parameters?: FTAggregateParameters): Promise<[number, ...Array<string[]>]>;
    /**
     ...
     */
    spellcheck(index: string, query: string, options?: FTSpellCheck): Promise<string[]>;
    /**
     ...
     */
    config(command: 'GET' | 'SET' | 'HELP', option: string, value?: string): Promise<FTConfig>;
}
/**
 ...
 */
export declare type FTCreateParameters = {
    filter?: string;
    payloadField?: string;
 ...
 */
export declare type FTFieldOptions = {
    sortable?: boolean;
    noindex?: boolean;
    nostem?: boolean;
    phonetic?: string;
 ...
 */
export declare type FTSearchParameters = {
    noContent?: boolean;
    verbatim?: boolean;
    noStopWords?: boolean;
    withScores?: boolean;
 ...
 */
export declare type FTExpression = {
    expression: string;
    as: string;
};
/**
 ...
 */
export declare type FTSortByProperty = {
    property: string;
    sort: FTSort;
};
/**
 ...
 */
export declare type FTSort = 'ASC' | 'DESC';
/**
 ...
 */
export declare type FTSugAddParameters = {
    incr: number;
    payload: string;
};
/**
 ...
 */
export declare type FTSugGetParameters = {
    fuzzy: string;
    max: number;
    withScores: boolean;
    withPayloads: boolean;
 ...
 */
export declare type FTSpellCheck = {
    terms?: {
 ...
 */
export declare type FTFieldType = 'TEXT' | 'NUMERIC' | 'TAG' | string;
/**
 * The available index types
 * @param HASH The hash index type
 * @param JSON The JSON index type
 */
export declare type FTIndexType = 'HASH' | 'JSON';
/**
 * The config response
 */
export declare type FTConfig = {
    EXTLOAD?: string | null;
    SAFEMODE?: string;
