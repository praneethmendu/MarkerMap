 ...
 */
export declare type TensorType = 'FLOAT' | 'DOUBLE' | 'INT8' | 'INT16' | 'INT32' | 'INT64' | 'UINT8' | 'UINT16';
/**
 ...
 */
export declare type AIModelSetParameters = {
    tag?: string;
    batch?: {
        size: string;
        minSize?: string;
 ...
 */
export declare type AIBackend = 'TF' | 'TFLITE' | 'TORCH' | 'ONNX';
/**
 * The available device types
 * @param CPU The CPU device
 * @param GPU The GPU device
 */
export declare type AIDevice = 'CPU' | 'GPU' | string;
/**
 ...
 */
export declare type AIScriptSetParameters = {
    device: string;
    tag?: string;
    script: string;
};
 ...
 */
export declare type AIDagExecuteParameters = {
 ...
 */
export declare type AITensorInfo = {
    dtype?: TensorType;
    shape?: string[];
    values?: string[];
    blob?: string;
 ...
 */
export declare type AIModelExecute = {
    inputsCount: number;
    inputs: string[];
    outputsCount: number;
    outputs: string[];
 ...
 * @param timeout The time (in ms) after which the client is unblocked and a TIMEDOUT string is returned
 */
export declare type AIScriptExecuteParameters = {
    numberOfKeys: number;
    keys: string[];
