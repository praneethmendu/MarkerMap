...
export declare class Redis extends Module {
    /**
 ...
 */
export declare type RedisIntervalSetMixin = {
 ...
 */
export declare type RedisAIMixin = {
 ...
 */
export declare type RedisBloomMixin = {
 ...
 */
export declare type RedisBloomCMKMixin = {
 ...
 */
export declare type RedisBloomCuckooMixin = {
 ...
 */
export declare type RedisBloomTopKMixin = {
 ...
 */
export declare type RedisBloomTDigestMixin = {
 ...
 */
export declare type RedisearchMixin = {
 ...
 */
export declare type RedisGearsMixin = {
 ...
 */
export declare type RedisGraphMixin = {
 ...
 */
export declare type ReJSONMixin = {
 ...
 */
export declare type RedisTimeSeriesMixin = {
 ...
 */
export declare const modulePropNames: {
    RedisAI: string;
    RedisIntervalSets: string;
    RedisBloom: string;
    RedisBloomCMK: string;
    RedisBloomCuckoo: string;
    RedisBloomTopK: string;
    RedisBloomTDigest: string;
    Redisearch: string;
    RedisGears: string;
    RedisGraph: string;
    ReJSON: string;
    RedisTimeSeries: string;
};
/**
