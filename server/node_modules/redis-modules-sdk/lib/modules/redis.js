...
exports.modulePropNames = exports.Redis = void 0;
const module_base_1 = require("./module.base");
const redis_ai_1 = require("./redis-ai");
const redisbloom_1 = require("./redisbloom");
const redisbloom_cmk_1 = require("./redisbloom-cmk");
const redisbloom_cuckoo_1 = require("./redisbloom-cuckoo");
const redisbloom_tdigest_1 = require("./redisbloom-tdigest");
const redisbloom_topk_1 = require("./redisbloom-topk");
const redisearch_1 = require("./redisearch");
const redisgears_1 = require("./redisgears");
const redisgraph_1 = require("./redisgraph");
const rejson_1 = require("./rejson");
const ris_1 = require("./ris");
const rts_1 = require("./rts");
class Redis extends module_base_1.Module {
