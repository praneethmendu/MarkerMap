...
class RedisBloomTDigest extends module_base_1.Module {
    ...
    create(key, compression) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('TDIGEST.CREATE', [key, `${compression}`]);
        });
    }
    /**
    ...
    reset(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('TDIGEST.RESET', [key]);
        });
    }
    /**
    ...
    add(key, parameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.sendCommand('TDIGEST.ADD', args);
        });
    }
    /**
    ...
    merge(fromKey, toKey) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('TDIGEST.MERGE', [toKey, fromKey]);
        });
    }
    /**
    ...
    min(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('TDIGEST.MIN', [key]);
        });
    }
    /**
    ...
    max(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('TDIGEST.MAX', [key]);
        });
    }
    /**
    ...
    quantile(key, quantile) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('TDIGEST.QUANTILE', [key, quantile]);
        });
    }
    /**
    ...
    cdf(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.sendCommand('TDIGEST.CDF', [key, value]);
        });
    }
    /**
    ...
    info(key) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.sendCommand('TDIGEST.INFO', [key]);
