...
class ReJSON extends module_base_1.Module {
    ...
    del(key, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.sendCommand('JSON.DEL', parameters);
        });
    }
    /**
    ...
    set(key, path, json, condition) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (condition)
                args.push(condition);
            return yield this.sendCommand('JSON.SET', args);
        });
    }
    /**
    ...
    get(key, path, parameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            return yield this.sendCommand('JSON.GET', args);
        });
    }
    /**
    ...
    mget(keys, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            return yield this.sendCommand('JSON.MGET', args);
        });
    }
    /**
    ...
    type(key, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            return yield this.sendCommand('JSON.TYPE', args);
        });
    }
    /**
    ...
    numincrby(key, number, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.sendCommand('JSON.NUMINCRBY', args);
        });
    }
    /**
    ...
    nummultby(key, number, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            args.push(number.toString());
            return yield this.sendCommand('JSON.NUMMULTBY', args);
        });
    }
    /**
    ...
    strappend(key, string, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            return yield this.sendCommand('JSON.STRAPPEND', args.concat(string));
        });
    }
    /**
    ...
    strlen(key, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            return yield this.sendCommand('JSON.STRLEN', args);
        });
    }
    /**
    ...
    arrappend(key, items, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            return yield this.sendCommand('JSON.ARRAPPEND', args.concat(items));
        });
    }
    /**
    ...
    arrindex(key, scalar, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            args.push(scalar);
            return yield this.sendCommand('JSON.ARRINDEX', args);
        });
    }
    /**
    ...
    arrinsert(key, index, json, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            args.push(json);
            return yield this.sendCommand('JSON.ARRINSERT', args);
        });
    }
    /**
    ...
    arrlen(key, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            return yield this.sendCommand('JSON.ARRLEN', args);
        });
    }
    /**
    ...
    arrpop(key, index, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            args.push(index.toString());
            return yield this.sendCommand('JSON.ARRPOP', args);
        });
    }
    /**
    ...
    arrtrim(key, start, end, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.sendCommand('JSON.ARRTRIM', args);
        });
    }
    /**
    ...
    objkeys(key, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            return yield this.sendCommand('JSON.OBJKEYS', args);
        });
    }
    /**
    ...
    objlen(key, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                args.push(path);
            return yield this.sendCommand('JSON.OBJLEN', args);
        });
    }
    /**
    ...
    debug(subcommand, key, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.sendCommand('JSON.DEBUG', args);
        });
    }
    /**
    ...
    forget(key, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                parameters.push(path);
            return yield this.sendCommand('JSON.FORGET', parameters);
        });
    }
    /**
    ...
    resp(key, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (path !== undefined)
                parameters.push(path);
            return yield this.sendCommand('JSON.RESP', parameters);
        });
    }
}
